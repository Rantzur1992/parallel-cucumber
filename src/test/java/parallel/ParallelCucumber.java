...
/**
 * Step definitions for login_scenario_one.feature.
 */
public class ParallelCucumber {
     ...
     */
    @Given("I navigate to the TestProject example page {int}")
    public void navigateToPage(int port) throws Exception {
        driver = new ChromeDriver(new URL("http://localhost:" + port), new ChromeOptions(), "Cucumber", "Login Scenario");
